...
| Race start on current candidate | UNVALIDATED PHYSICALLY | The restored #78 foundation launched and drove. This changed DLL must pass launch, race start and normal driving before RC. The historical E1–E4 feasibility runtime was not brought forward. |
